function Projects() {
    const projects = [
        { name: 'tutor-time', description: 'Full Stack MERN app that allows students to find tutors based on subject. Bcrypt and JSON Web Tokens verify users and information. Apollo Client/Server and GraphQL are used to write and test queries and mutations. Deployed to Heroku.', github: 'https://github.com/spencermoyer22/tutor-time', website: 'https://tranquil-hollows-19559.herokuapp.com/' }, 
        ...
        { name: 'gun-show', description: ' Health based social media account using MVC architecture. Handlebars create the fornt end. MySQL and Sequelize make up the back end. Uses express to create API routes. Deployed to Heroku.', github: 'https://github.com/spencermoyer22/JustTechGunShow', website: 'https://thawing-plains-49978.herokuapp.com/' }, 
        { name: 'budget-tracker', description: 'Created a Progressive Web Application to track a budget. Uses IndexedDb and Service Workers to function offline and save information to MongoDB when back online. Uses manifest to downloaded site as an application. Deployed to Heroku.', github: 'https://github.com/spencermoyer22/budget-tracker', website: 'https://obscure-journey-56604.herokuapp.com/' }, 
            ...
            <div className='row mt-5'>
                {projects.map((project) => (
                    <div className='project mx-auto col-xl-4 col-lg-6 col-sm-12 p-0 m-0' style={{position: 'relative'}}>
                        ...
                        ></img>
                        <div className='project-overlay py-4'>
