function Projects() {
    const projects = [
        { name: 'tutor-time', description: 'Full Stack MERN find tutors based on subject. Bcrypt and JSON Web Tokens verify users and information. Apollo Client/Server and GraphQL are used to write and test queries and mutations. Deployed to Heroku.', github: 'https://github.com/spencermoyer22/tutor-time', website: 'https://tranquil-hollows-19559.herokuapp.com/' }, 
